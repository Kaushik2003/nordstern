...
export default function PricingPage() {
  ...
  const LIVE_PRICING = useMemo(() => {
    ...
    // For demo purposes, we will treat the live FX rate's fractional part as a variance factor
    // against our baseline to show dynamic pricing recommendations.
  ...
  return (
    <PageContainer>
      <PageHeader 
        title="Pricing & Liquidity" 
        subtitle="Set what you charge. NordStern recommends the optimal spread from live market conditions." 
