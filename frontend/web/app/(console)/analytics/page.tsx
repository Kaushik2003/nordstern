...
export default function AnalyticsPage() {
  ...
  const next24 = volumeForecast.filter((p) => !p.actual).slice(0, 24).reduce((s, p) => s + p.value, 0);
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          <CardBody>
            ...
            <div className="mt-3"><HBars data={sourceAttribution.map((s) => ({ label: s.source, value: s.count }))} color="var(--color-pos)" fmt={(n) => String(n)} /></div>
